...
const Features = () => {
  ...
  const cards = [{
     Image1 : "/fitguide/assets/image/cardlogo1.jpg",
  ...
  {
    Image1 : "/fitguide/assets/image/cardlogo2.jpg",
  ...
  {
    Image1 : "/fitguide/assets/image/cardLogo3.jpg",
  ...
  return (
    <>
    <Header>
       <Hero image="/fitguide/assets/image/fruite.jpeg" title="Features FitGuide" 
