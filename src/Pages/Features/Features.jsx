...
const Features = () => {
  ...
  const cards = [{
     Image1 : "/assets/image/cardlogo1.jpg",
  ...
  {
    Image1 : "/assets/image/cardlogo2.jpg",
  ...
  {
    Image1 : "/assets/image/cardLogo3.jpg",
  ...
  return (
    <>
    <Header>
       <Hero image="/assets/image/fruite.jpeg" title="Features FitGuide" 
